"""Build the lineage kernel used by LinTopoGRN from a Newick tree."""

import argparse, os, numpy as np, pandas as pd
from LinTopoGRN_model import build_lineage_K_from_newick

def main():
    parser = argparse.ArgumentParser(description="Build the lineage kernel used by LinTopoGRN from a Newick tree.")
